    ...
    public static class AzureResourceManagerUtil
    {
        ...
        public static List<Organization> GetUserOrganizations()
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                {
                    var spid = AzureADGraphApiUtil.GetObjectIdOfServicePrincipalInOrganization(organization.tenantId, Config.ClientId);

                    //if (!string.IsNullOrEmpty(spid))
                    if (spid != string.Empty)
                    {
                        Organization orgDetails = AzureADGraphApiUtil.GetOrganizationDetails(organization.tenantId);
        ...
        public static void GrantRoleToServicePrincipalOnSubscription(string objectId, string subscriptionId)
        {
            ...
            string roleDefinitionId = GetRoleId(ConfigurationManager.AppSettings["ida:RequiredARMRoleOnSubscription"], subscriptionId);
        ...
        /// <param name="subscriptionId">The subscription identifier.</param>
        /// <returns></returns>
        public static string GetRoleId(string roleName, string subscriptionId)
        {
            string roleId = null;
            string signedInUserUniqueName = ClaimsPrincipal.Current.SignedInUserName();
        ...
        /// <returns></returns>
        public static string AddCurrentUserAsContributor(string subscriptionId, string resourceGroupName)
        {
