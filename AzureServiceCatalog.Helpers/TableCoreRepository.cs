...
namespace AzureServiceCatalog.Helpers
{
    ...
    public class TableCoreRepository
    {
        ...
        public List<Subscription> GetSubscriptionListByOrgId(string orgID)
        {
        ...
        public Organization GetOrganizationSync(string organizationId)
        {
            var table = TableUtil.GetCoreTableReference(Tables.Organizations);
            var retrieveOperation = TableOperation.Retrieve<Organization>(partitionKey, organizationId);
            var tableResult = table.Execute(retrieveOperation);
        ...
        public List<Subscription> GetEnrolledSubscriptionListByOrgId(string orgID)
        {
