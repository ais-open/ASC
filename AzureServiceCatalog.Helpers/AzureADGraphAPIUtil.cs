...
namespace AzureServiceCatalog.Helpers
{
    public static class AzureADGraphApiUtil
    {
        ...
        public static async Task<Organization> GetOrganizationDetails(string organizationId)
        {
        ...
        public static async Task<List<ADGroup>> GetAllGroupsForOrganization(string organizationId, string filter = null)
        {
            Uri requestUrl = null;
        ...
        public static async Task<ADGroup> CheckIfADGroupExistsByOrgName(string organizationId, string adGroupName)
        {
            Uri requestUrl = null;
        ...
        public static async Task<List<ADGroup>> GetUserGroups(string objectId, string organizationId)
        {
        ...
        public static async Task<string> GetObjectIdOfServicePrincipalInOrganization(string organizationId, string applicationId)
        {
