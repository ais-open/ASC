...
namespace AzureServiceCatalog.Helpers
{
    public static class Utils
    {
        ...
        public static async Task<List<string>> GetCurrentUserGroups()
        {
            List<string> userGroups = null;
            var userAdGroups = await AzureADGraphApiUtil.GetUserGroups(ClaimsPrincipal.Current.UserId(), ClaimsPrincipal.Current.TenantId());
